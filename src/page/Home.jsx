    ...
    <div className="category">
      ...
      <div className="image">
        <div className="image1">
          <Link to={"/phoneshop2024/shop/iphone"}>
            <img src={dm1} alt="" />
          </Link>
          <Link to={"/phoneshop2024/shop/macbook"}>
            <img src={dm2} alt="" />
          </Link>
        </div>
        <div className="image2">
          <Link to={"/phoneshop2024/shop/ipad"}>
            <img src={dm3} alt="" />
          </Link>
          <Link to={"/phoneshop2024/shop/watch"}>
            {" "}
            <img src={dm4} alt="" />
          </Link>
          <Link to={"/phoneshop2024/shop/airpod"}>
            <img src={dm5} alt="" />
          </Link>
        </div>
      </div>
...
function ProductTop() {
  ...
  useEffect(() => {
    ...
    setlistProuductsDefault(data && data.slice(0, 8));
  }, [data]);
